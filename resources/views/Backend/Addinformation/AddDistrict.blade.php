                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header">
                                            <h4 class="modal-title text-center"> ข้อมูลอำเภอ </h4>
                                        ...
                                        <div class="modal-body text-left">
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input class="form-control" id="pwd" placeholder=" ชื่อจังหวัด "
                                                            name="pwd">
                                                    </div>
                                                </div>
                                                <br>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input class="form-control" id="pwd" placeholder=" ชื่ออำเภอ"
                                                            name="pwd">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-success" data-dismiss="modal"> บันทึก
                                                </button>
