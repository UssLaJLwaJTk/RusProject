                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h4 class="modal-title text-center"> ข้อมูลประชาสัมพันธ์ </h4>
                                ...
                                <div class="modal-body text-left">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3    ">
                                                <div style="line-height: 25pt"> ชื่อประเภท : </div>
                                            </div>
                                            <div class="col-sm-5">
                                                <input class="form-control" id="pwd" placeholder=" ชื่อประเภท " name="pwd">
                                            </div>
                                        </div>
                                        <br>
