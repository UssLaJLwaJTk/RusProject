                                    ...
                                    <div class="modal-body text-left">
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-5">
                                                    <input class="form-control" id="pwd" placeholder=" ชื่อคำนำหน้าภาษาไทย "
                                                        name="pwd">
                                                </div>
                                            </div>
                                            <br>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <div style="line-height: 25pt"> ตัวย่อคำนำ : </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <input class="form-control" id="pwd" placeholder=" ตัวย่อภาษาไทย "
                                                        name="pwd">
                                                </div>
                                            </div>
                                            <br>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-5">
                                                    <input class="form-control" id="pwd" placeholder=" ชื่อคำนำหน้าภาษาอังกฤษ "
                                                        name="pwd">
                                                </div>
                                            </div>
                                            <br>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3">
                                                    <input class="form-control" id="pwd" placeholder=" ตัวย่อภาษาอังกฤษ "
                                                        name="pwd">
                                                </div>
                                            </div>
                                            <br>
